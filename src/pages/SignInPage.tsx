        ...
        <div className="w-full max-w-[440px]">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8 sm:p-10">
            ...
            <p className="text-[#818181] text-sm text-center mb-8 font-cabinet leading-relaxed">
              Sign in to access your Poietes account and all connected products.
            </p>
            ...
            <form onSubmit={(e) => {
              ...
              {/* Email */}
              <div className="mb-4">
                <label htmlFor="signin-email" className="block text-sm font-cabinet font-medium text-[#1a1a1a] mb-2">
                  Email Address
                </label>
                <input
                  id="signin-email"
              ...
              {/* Password */}
              <div className="mb-2">
                <label htmlFor="signin-password" className="block text-sm font-cabinet font-medium text-[#1a1a1a] mb-2">
                  Password
                </label>
              ...
              <div className="flex justify-end mb-6">
                <Link to="/forgot-password" className="text-[#FF6730] text-xs font-cabinet font-medium hover:underline">
                  Forgot password?
                </Link>
              </div>
            ...
            <p className="text-center mt-6 text-sm font-cabinet text-[#818181]">
              ...
              <Link to="/signup" className="text-[#FF6730] font-medium hover:underline">Create one</Link>
            </p>
          </div>
        </div>
      </div>
